...
**Companion docs:** [School connection checklist](./school-connection-checklist.md) (try the AirPlay shortcut first) · [DIY options, budget tiers & product/Kickstarter exploration](./diy-options-and-product-exploration.md) · [Milestone M1 build spec](./m1-spec.md) · [MiraBridge OSS project scaffold](../mirabridge/README.md).
